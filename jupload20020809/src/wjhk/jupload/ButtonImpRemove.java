...
public class ButtonImpRemove extends Panel implements Button{
  ...
  public ButtonImpRemove(){
    this.setLayout(new BorderLayout());
    actionCommand = "Remove Selected";
    button = new JButton(actionCommand);
    ImageIcon icon = new ImageIcon(getClass().getResource("/images/recycle.gif"));
    button.setIcon(icon);
    this.add(button);
